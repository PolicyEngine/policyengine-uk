...
def load_lcfs(year: int) -> MicroDataFrame:
    ...
    # Return household-level LCFS dataset with categorised consumption
    # and FRS-shared columns
    return MicroDataFrame(lcfs, weights=households.weighta[lcfs.index] * 1000)
...
def load_and_process_lcf(
    ...
    """
    Load and process the LCFS and NCFS summary data.

    Args:
        year (int): The year of LCFS to use.

    Returns:
        Tuple[pd.DataFrame, pd.DataFrame]: The LCFS household and person tables.
    """
