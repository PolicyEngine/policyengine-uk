...
def backdate_parameters(root: str = None, first_instant: str = "2010-01-01") -> Reform:
        ...
        for param in node.get_descendants():
            if hasattr(param, "values_list"):
                ...
                if first_instant < earliest_instant:
                    ...
                    param.update(period=periods.Period(("day", first_instant, num_days)), value=earliest_value)
        return parameters
