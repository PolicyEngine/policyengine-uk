...
class NI_class_4(Variable):
    ...
    def formula(person, period, parameters):
        ...
        main_amount = amount_between(profits, class_4.thresholds.lower_profits_limit, class_4.thresholds.upper_profits_limit)
        add_amount = amount_over(profits, class_4.thresholds.upper_profits_limit)
        charge = main_amount * class_4.rates.main + add_amount * class_4.rates.additional
        return charge
