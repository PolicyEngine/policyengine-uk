...
class benefit_modelling(Variable):
    ...
    def formula(benunit, period, parameters):
        ...
        return sum(map(lambda benefit : benunit(benefit, period) - benunit(f"{benefit}_reported", period), MODELLED_BENEFITS))
...
class equiv_benunit_net_income(Variable):
    ...
    def formula(benunit, period, parameters):
        return benunit("benunit_net_income", period) / benunit("benunit_equivalisation")