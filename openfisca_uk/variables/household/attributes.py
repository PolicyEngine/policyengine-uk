...
class poverty_gap_bhc(Variable):
    ...
    def formula(household, period, parameters):
        poverty_line = parameters(period).poverty.absolute_poverty_threshold_bhc / household("household_equivalisation_bhc", period.this_year)
...
class poverty_gap_ahc(Variable):
    ...
    def formula(household, period, parameters):
        poverty_line = parameters(period).poverty.absolute_poverty_threshold_ahc / household("household_equivalisation_ahc", period.this_year)
