...
class basic_income(Variable):
    ...
    def formula(person, period, parameters):
        ...
        return person('is_senior', period) * 165 + adult_young * 120 + adult_old * 150 + disabled_adult * 35 + disabled_child * 60 + person('is_child', period) * 100
...
class simulation_3(Reform):
    def apply(self):
        ...
        for removed_var in ["child_benefit", "housing_benefit_actual", "income_JSA", "income_support", "child_tax_credit", "working_tax_credit"]:
