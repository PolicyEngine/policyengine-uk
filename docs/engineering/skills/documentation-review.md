...
Documentation review verifies technical accuracy; it is not limited to
copyediting. Confirm that durable documentation still describes the code paths
a maintainer or AI agent would use to understand, validate, or modify the model.
