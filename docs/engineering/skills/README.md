...
`.github/CONTRIBUTING.md` contains the repository contribution requirements and
links to the shared PolicyEngine contribution guide. These task-specific files
extend those guides for AI coding tools and must not contradict them.
