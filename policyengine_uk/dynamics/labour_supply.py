...
This module provides functions to calculate labour supply responses to policy changes
using elasticity-based models. It implements the methodology from the OBR's labour
supply elasticity framework to estimate how changes in tax and benefit policies
...
def apply_labour_supply_responses(
    ...
    a PolicyEngine simulation. It calculates how individuals adjust their
    labour supply in response to policy changes and updates the simulation
    with these behavioural responses.
