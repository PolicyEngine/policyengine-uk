...
class ni_class_4_maximum(Variable):
    ...
    def formula(person, period, parameters):
        p = parameters(period).gov.hmrc.national_insurance
        upl = p.class_4.thresholds.upper_profits_limit
        lpl = p.class_4.thresholds.lower_profits_limit
        step_1 = upl - lpl
        main_rate = p.class_4.rates.main
        add_rate = p.class_4.rates.additional
        step_2 = step_1 * main_rate
        step_3 = step_2 + 53 * p.class_2.flat_rate
