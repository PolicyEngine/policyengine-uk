...
class extended_childcare_entitlement_30_hours_eligibility(Variable):
    value_type = bool
    entity = BenUnit
    ...
    def formula(benunit, period, parameters):
        """
        Calculate eligibility for 30 hours program.
        """
        # Age eligibility
        age_eligible = benunit.any(
            benunit.members("extended_childcare_entitlement_30_hours", period)
        )
