...
class savings_credit(Variable):
    ...
    def formula(benunit, period, parameters):
        ...
        threshold = p.threshold[relation_type] * WEEKS_IN_YEAR
        ...
        maximum_savings_credit = p.rate.phase_in * (
            minimum_guarantee - threshold
        )
        phased_in_sc = min_(
            maximum_savings_credit, p.rate.phase_in * income_over_threshold
        )
        sc_reduction = p.rate.phase_out * income_over_mg
