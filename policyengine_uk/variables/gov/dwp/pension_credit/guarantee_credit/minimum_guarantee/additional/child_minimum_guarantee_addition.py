...
class child_minimum_guarantee_addition(Variable):
    ...
    def formula(benunit, period, parameters):
        ...
        standard_disability_benefits = p.child.disability.eligibility
        severe_disability_benefits = p.child.disability.severe.eligibility
        ...
        per_child_amount = (
            select(
                ...
                [
                    p.child.addition,
                    p.child.addition + p.child.disability.addition,
                    p.child.addition + p.child.disability.severe.addition,
                ],
            )
            * WEEKS_IN_YEAR
        )
