...
class bromley_council_tax_reduction_tariff_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Bromley Council Tax Support tariff income from capital"
    ...
    def formula(benunit, period, parameters):
        ...
        tariff = parameters(
            period
        ).gov.local_authorities.bromley.council_tax_reduction.means_test.tariff_income
