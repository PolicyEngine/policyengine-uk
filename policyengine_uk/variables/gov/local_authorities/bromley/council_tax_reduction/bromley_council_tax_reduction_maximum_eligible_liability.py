...
class bromley_council_tax_reduction_maximum_eligible_liability(Variable):
    value_type = float
    entity = Household
    label = "Bromley maximum Council Tax liability eligible for Council Tax Support"
    ...
    def formula(household, period, parameters):
        ...
        working_age = is_bromley_working_age(
