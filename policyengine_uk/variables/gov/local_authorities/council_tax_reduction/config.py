...
def is_ashford(local_authority):
...
def is_brentwood(local_authority):
    return local_authority == LocalAuthority.BRENTWOOD
...
def is_chelmsford(local_authority):
...
def is_chichester(local_authority):
    return local_authority == LocalAuthority.CHICHESTER
...
def is_colchester(local_authority):
...
def is_dartford(local_authority):
    return local_authority == LocalAuthority.DARTFORD


def is_derby(local_authority):
    return local_authority == LocalAuthority.DERBY
...
def is_ipswich(local_authority):
    return local_authority == LocalAuthority.IPSWICH
...
def is_plymouth(local_authority):
    return local_authority == LocalAuthority.PLYMOUTH
...
def is_slough(local_authority):
    return local_authority == LocalAuthority.SLOUGH


def is_south_gloucestershire(local_authority):
    return local_authority == LocalAuthority.SOUTH_GLOUCESTERSHIRE
...
def is_southend_on_sea(local_authority):
    return local_authority == LocalAuthority.SOUTHEND_ON_SEA
...
def is_west_berkshire(local_authority):
    return local_authority == LocalAuthority.WEST_BERKSHIRE
...
def is_basildon_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_basildon(local_authority)
...
def is_brentwood_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_brentwood(local_authority)
...
def is_chelmsford_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND) & ~has_pensioner & is_chelmsford(local_authority)
    )
...
def is_chichester_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND) & ~has_pensioner & is_chichester(local_authority)
    )
...
def is_colchester_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND) & ~has_pensioner & is_colchester(local_authority)
    )
...
def is_dartford_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_dartford(local_authority)


def is_derby_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_derby(local_authority)
...
def is_ipswich_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_ipswich(local_authority)
...
def is_plymouth_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_plymouth(local_authority)
...
def is_slough_working_age(local_authority, country, has_pensioner):
    return (country == Country.ENGLAND) & ~has_pensioner & is_slough(local_authority)


def is_south_gloucestershire_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND)
        & ~has_pensioner
...
def is_southend_on_sea_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND)
        & ~has_pensioner
...
def is_west_berkshire_working_age(local_authority, country, has_pensioner):
    return (
        (country == Country.ENGLAND)
        & ~has_pensioner
...
def is_supported_scheme(local_authority, country, has_pensioner):
    return (
        ...
        | is_dartford_working_age(local_authority, country, has_pensioner)
        | is_derby_working_age(local_authority, country, has_pensioner)
        ...
        | is_ipswich_working_age(local_authority, country, has_pensioner)
        ...
        | is_south_gloucestershire_working_age(local_authority, country, has_pensioner)
        ...
        | is_west_berkshire_working_age(local_authority, country, has_pensioner)
