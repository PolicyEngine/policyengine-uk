...
class tameside_council_tax_reduction_maximum_eligible_liability(Variable):
    value_type = float
    entity = Household
    label = "Tameside maximum Council Tax liability eligible for CTR"
    ...
    def formula(household, period, parameters):
        ...
        working_age = is_tameside_working_age(
