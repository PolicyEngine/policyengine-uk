...
class enfield_council_tax_reduction_applicable_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Enfield CTR applicable income"
    ...
    def formula(benunit, period, parameters):
        ...
        childcare_deduction = benunit(
            "enfield_council_tax_reduction_childcare_deduction", period
        )
        net_earnings = max_(
