...
class gloucester_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Gloucester Council Tax Support"
    ...
    def formula(benunit, period, parameters):
        ...
        ) + benunit("gloucester_council_tax_reduction_tariff_income", period)
        uc_applicable_income = benunit(
            "gloucester_council_tax_reduction_uc_applicable_income", period
        )
        ...
        non_dep_deductions = benunit(
            "gloucester_council_tax_reduction_non_dep_deductions",
            period,
        )
        award = max_(
            0,
