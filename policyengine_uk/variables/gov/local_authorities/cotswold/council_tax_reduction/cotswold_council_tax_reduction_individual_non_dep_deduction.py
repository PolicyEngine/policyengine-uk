...
class cotswold_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Cotswold Council Tax Support individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        claimant_exempt = household.any(
            ...
            & (
                ...
                | household_person(
                    "cotswold_council_tax_reduction_claimant_source_non_dep_exemption",
                    period,
                )
        ...
        uc_no_earned_income = (
            ...
            person(
                "cotswold_council_tax_reduction_non_dep_uc_earned_income",
                period,
            )
            <= 0
        )
        exempt = (
            ...
            | income_based_benefit
            | uc_no_earned_income
            | person("cotswold_council_tax_reduction_non_dep_source_exemption", period)
        )
