...
class cotswold_council_tax_reduction_maximum_eligible_liability(Variable):
    value_type = float
    entity = Household
    label = "Cotswold maximum Council Tax liability eligible for Council Tax Support"
    ...
    def formula(household, period, parameters):
        ...
        cap_band_ratio = local_authorities.cotswold.council_tax_reduction.maximum_liability.cap_band_ratio
