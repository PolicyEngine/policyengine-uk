...
class colchester_council_tax_reduction_maximum_eligible_liability(Variable):
    value_type = float
    entity = Household
    label = "Colchester maximum Council Tax liability eligible for CTR"
    ...
    def formula(household, period, parameters):
        ...
        cap_band_ratio = local_authorities.colchester.council_tax_reduction.maximum_liability.cap_band_ratio
