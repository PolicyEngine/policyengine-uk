...
class colchester_council_tax_reduction_childcare_deduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Colchester CTR eligible childcare deduction"
    ...
    def formula(benunit, period, parameters):
        ...
        unable_to_work = (
            ...
            | person(
                "colchester_council_tax_reduction_childcare_disabled_partner", period
            )
        ) & claimant_or_partner
        ...
        eligible_child = child_or_young_person & (
            ...
            | (
                ...
                & (
                    ...
                    | person(
                        "colchester_council_tax_reduction_childcare_disabled_child",
                        period,
                    )
                )
            )
