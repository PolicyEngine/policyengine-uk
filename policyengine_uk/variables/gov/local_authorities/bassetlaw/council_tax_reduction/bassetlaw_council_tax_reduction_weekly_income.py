...
class bassetlaw_council_tax_reduction_weekly_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Bassetlaw Council Tax Reduction weekly income"
    ...
    def formula(benunit, period, parameters):
        ...
        uc_weekly_income = benunit(
            "bassetlaw_council_tax_reduction_uc_weekly_income", period
        )
        ...
        earnings_disregard = benunit(
            "bassetlaw_council_tax_reduction_earnings_disregard", period
        )
        ...
        disregarded_income = add(
            ...
            [
                ...
                "armed_forces_independence_payment",
                "housing_benefit",
                "bassetlaw_council_tax_reduction_source_disregarded_income",
            ],
        )
        ...
        weekly_income = where(
            ...
            + benunit("bassetlaw_council_tax_reduction_weekly_tariff_income", period),
        )
