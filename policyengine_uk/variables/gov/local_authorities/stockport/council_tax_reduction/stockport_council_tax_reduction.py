...
class stockport_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Stockport Council Tax Support"
    ...
    def formula(benunit, period, parameters):
        ...
        working_age = is_stockport_working_age(local_authority, country, has_pensioner)
        ...
        return legacy_council_tax_reduction(
            ...
            ctr,
            working_age,
            "stockport_council_tax_reduction_non_dep_deductions",
