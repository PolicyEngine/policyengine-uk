...
class maldon_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Maldon individual Council Tax Reduction non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        return flat_non_dep_deduction(person, period, ctr, local_scheme)
