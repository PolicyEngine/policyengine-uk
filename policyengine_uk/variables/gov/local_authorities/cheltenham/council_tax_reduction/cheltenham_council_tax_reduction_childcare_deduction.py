...
class cheltenham_council_tax_reduction_childcare_deduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Cheltenham Council Tax Support childcare deduction from earnings"
    ...
    def formula(benunit, period, parameters):
        childcare = parameters(
            period
        ).gov.local_authorities.cheltenham.council_tax_reduction.childcare
        ...
        unable_to_work = (
            ...
            | person(
                "cheltenham_council_tax_reduction_childcare_disabled_partner", period
            )
        ) & claimant_or_partner
        ...
        eligible_child = child_or_young_person & (
            ...
            | (
                ...
                & (
                    ...
                    | person(
                        "cheltenham_council_tax_reduction_childcare_disabled_child",
                        period,
                    )
                )
            )
