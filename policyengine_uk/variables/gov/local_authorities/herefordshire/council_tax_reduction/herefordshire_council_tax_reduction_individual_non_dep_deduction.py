...
class herefordshire_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Herefordshire Council Tax Reduction individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ctr = parameters(
            period
        ).gov.local_authorities.herefordshire.council_tax_reduction
        ...
        exempt = (
            ...
            | uc_no_earned_income
            | person(
                "herefordshire_council_tax_reduction_non_dep_source_exemption", period
            )
        )
