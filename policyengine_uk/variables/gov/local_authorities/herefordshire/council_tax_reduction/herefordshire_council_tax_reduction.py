...
class herefordshire_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Herefordshire Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        uc_applicable_income = benunit(
            "herefordshire_council_tax_reduction_uc_applicable_income", period
        )
        ...
        non_dep_deductions = benunit(
            "herefordshire_council_tax_reduction_non_dep_deductions", period
        )
        award = max_(
            0,
