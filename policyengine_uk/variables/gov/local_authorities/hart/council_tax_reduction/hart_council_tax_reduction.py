...
class hart_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Hart Council Tax Support"
    ...
    def formula(benunit, period, parameters):
        ...
        local_scheme = benunit("hart_council_tax_reduction_is_local_scheme", period)
        has_uc_award = (
            max_(
        ...
        applicable_income = where(
            has_uc_award,
            benunit("hart_council_tax_reduction_uc_applicable_income", period),
        ...
        non_dep_deductions = benunit(
            "hart_council_tax_reduction_non_dep_deductions", period
        )
        award = max_(
            0,
