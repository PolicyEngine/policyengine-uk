...
class mid_suffolk_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Mid Suffolk Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        non_dep_deductions = benunit(
            "mid_suffolk_council_tax_reduction_non_dep_deductions", period
        )
        ...
        ) + benunit("mid_suffolk_council_tax_reduction_tariff_income", period)
        ...
        weekly_uc_contribution = benunit(
            "mid_suffolk_council_tax_reduction_uc_weekly_contribution", period
        )
        uc_award = max_(
            0,
