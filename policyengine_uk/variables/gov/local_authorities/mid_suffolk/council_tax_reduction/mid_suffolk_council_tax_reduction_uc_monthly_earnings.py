...
class mid_suffolk_council_tax_reduction_uc_monthly_earnings(Variable):
    value_type = float
    entity = BenUnit
    label = "Mid Suffolk Council Tax Reduction Universal Credit notified monthly net earnings"
