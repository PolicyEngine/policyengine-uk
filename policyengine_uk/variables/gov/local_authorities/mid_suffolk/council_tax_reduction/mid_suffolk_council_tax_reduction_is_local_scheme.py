...
class mid_suffolk_council_tax_reduction_is_local_scheme(Variable):
    value_type = bool
    entity = BenUnit
    label = "Whether the benefit unit is under Mid Suffolk's local CTR scheme"
    ...
    def formula(benunit, period, parameters):
        ...
        return (
            ...
            & is_mid_suffolk(local_authority)
            & source_working_age
        )
