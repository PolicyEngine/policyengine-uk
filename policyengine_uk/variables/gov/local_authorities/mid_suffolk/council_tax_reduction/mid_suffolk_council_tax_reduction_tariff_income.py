...
class mid_suffolk_council_tax_reduction_tariff_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Mid Suffolk Council Tax Reduction tariff income"
    ...
    def formula(benunit, period, parameters):
        tariff = parameters(
            period
        ).gov.local_authorities.mid_suffolk.council_tax_reduction.means_test.tariff_income
