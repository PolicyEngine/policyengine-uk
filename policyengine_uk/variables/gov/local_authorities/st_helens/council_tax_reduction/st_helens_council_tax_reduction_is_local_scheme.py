...
class st_helens_council_tax_reduction_is_local_scheme(Variable):
    value_type = bool
    entity = BenUnit
    label = "Whether the benefit unit is under St Helens' local Council Tax Reduction scheme"
    ...
    def formula(benunit, period, parameters):
        ...
        uc_exception = benunit(
            "st_helens_council_tax_reduction_uc_regulation_60a_pensioner", period
        )
        local_case = (
        ...
        return (country == Country.ENGLAND) & is_st_helens(local_authority) & local_case
