...
class redbridge_council_tax_reduction_weekly_net_earnings(Variable):
    value_type = float
    entity = BenUnit
    label = "Redbridge Council Tax Reduction weekly net earnings"
    ...
    def formula(benunit, period, parameters):
        ...
        uc_earnings = max_(0, gross_earnings - uc_deductions)
        has_uc_award = benunit("universal_credit", period) > 0
        annual_earnings = where(
            has_uc_award,
            uc_earnings,
            non_uc_earnings,
        )
