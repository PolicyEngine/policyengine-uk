...
class chelmsford_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Chelmsford Local Council Tax Support individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        exempt = (
            ...
            | person(
                "chelmsford_council_tax_reduction_non_dep_source_exemption", period
            )
        )
