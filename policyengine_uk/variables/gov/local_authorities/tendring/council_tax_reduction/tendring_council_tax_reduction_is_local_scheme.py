...
class tendring_council_tax_reduction_is_local_scheme(Variable):
    value_type = bool
    entity = BenUnit
    label = "Whether the benefit unit is under Tendring's local Council Tax Reduction scheme"
    ...
    def formula(benunit, period, parameters):
        ...
        uc_exception = benunit(
            "tendring_council_tax_reduction_uc_relevant_period_pensioner", period
        ) | benunit(
            "tendring_council_tax_reduction_uc_regulation_60a_pensioner", period
        )
        local_case = (
        ...
        return (country == Country.ENGLAND) & is_tendring(local_authority) & local_case
