...
class cheshire_west_and_chester_council_tax_reduction_individual_non_dep_deduction(
    Variable
):
    value_type = float
    entity = Person
    label = "Cheshire West and Chester Council Tax Reduction individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        local_scheme = household.any(
            ...
            & household_person.benunit(
                "cheshire_west_and_chester_council_tax_reduction_is_local_scheme",
                period,
            )
        )
        ...
        person_gross_income = max_(
            0,
            add(person, period, gross_income_components)
            - person(
                "cheshire_west_and_chester_council_tax_reduction_non_dep_source_disregarded_income",
                period,
            ),
        )
        ...
        weekly_deduction = where(
            ...
            ctr.non_dep_deduction.not_remunerative_work,
        )
        ...
        claimant_exempt = household.any(
            ...
            & (
                ...
                | household_person(
                    "cheshire_west_and_chester_council_tax_reduction_claimant_source_non_dep_exemption",
                    period,
                )
        ...
        exempt = (
            ...
            | person(
                "cheshire_west_and_chester_council_tax_reduction_non_dep_source_exemption",
                period,
            )
        )
