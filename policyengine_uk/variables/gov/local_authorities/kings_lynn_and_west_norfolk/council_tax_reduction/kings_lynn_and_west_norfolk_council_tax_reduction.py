...
class kings_lynn_and_west_norfolk_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "King's Lynn and West Norfolk Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        return legacy_council_tax_reduction(
            ...
            ctr,
            working_age,
            "kings_lynn_and_west_norfolk_council_tax_reduction_non_dep_deductions",
        )
