...
class havering_council_tax_reduction_maximum_eligible_liability(Variable):
    value_type = float
    entity = Household
    label = "Havering maximum Council Tax liability eligible for CTS"
    ...
    def formula(household, period, parameters):
        ...
        working_age = is_havering_working_age(
