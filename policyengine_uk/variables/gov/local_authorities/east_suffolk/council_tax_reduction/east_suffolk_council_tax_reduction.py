...
class east_suffolk_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "East Suffolk Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        working_age = is_east_suffolk_working_age(
        ...
        return legacy_council_tax_reduction(
            ...
            ctr,
            working_age,
            "east_suffolk_council_tax_reduction_non_dep_deductions",
        )
