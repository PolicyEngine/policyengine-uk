...
class basildon_council_tax_reduction_weekly_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Basildon Council Tax Reduction weekly income"
    ...
    def formula(benunit, period, parameters):
        ...
        childcare_deduction = benunit(
            "basildon_council_tax_reduction_childcare_deduction", period
        )
