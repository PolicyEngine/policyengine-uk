...
class buckinghamshire_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Buckinghamshire Council Tax Reduction individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        local_scheme = household.any(
            ...
            & household_person.benunit(
                "buckinghamshire_council_tax_reduction_is_local_scheme",
                period,
            )
        )
        ...
        return local_scheme * where(exempt, 0.0, deduction)
