...
class westmorland_and_furness_council_tax_reduction_individual_non_dep_deduction(
    Variable
):
    value_type = float
    entity = Person
    label = "Westmorland and Furness Council Tax Reduction individual non-dependant deduction"
