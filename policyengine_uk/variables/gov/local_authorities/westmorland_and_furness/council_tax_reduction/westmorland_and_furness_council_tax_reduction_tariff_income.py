...
class westmorland_and_furness_council_tax_reduction_tariff_income(Variable):
    value_type = float
    entity = BenUnit
    label = "Westmorland and Furness Council Tax Reduction tariff income from capital"
    ...
    def formula(benunit, period, parameters):
        ...
        tariff = parameters(
            period
        ).gov.local_authorities.westmorland_and_furness.council_tax_reduction.means_test.tariff_income
