...
class westmorland_and_furness_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Westmorland and Furness Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ctr = parameters(
            period
        ).gov.local_authorities.westmorland_and_furness.council_tax_reduction
        ...
        non_uc_applicable_income = benunit(
            ...
            "westmorland_and_furness_council_tax_reduction_tariff_income", period
        )
        uc_applicable_income = benunit(
            "westmorland_and_furness_council_tax_reduction_uc_applicable_income",
            period,
        )
        ...
        non_dep_deductions = benunit(
            "westmorland_and_furness_council_tax_reduction_non_dep_deductions",
            period,
        )
        award = max_(
            0,
