...
class cumberland_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Cumberland Council Tax Reduction individual non-dependant deduction"
    ...
    def formula(person, period, parameters):
        ...
        working_age = is_cumberland_working_age(
        ...
        exempt = (
            ...
            | uc_no_earned_income
            | person(
                "cumberland_council_tax_reduction_non_dep_source_exemption", period
            )
        )
