...
class dudley_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Dudley Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        working_age = is_dudley_working_age(local_authority, country, has_pensioner)
        return legacy_council_tax_reduction(
            benunit,
            period,
            ctr,
            working_age,
            "dudley_council_tax_reduction_non_dep_deductions",
