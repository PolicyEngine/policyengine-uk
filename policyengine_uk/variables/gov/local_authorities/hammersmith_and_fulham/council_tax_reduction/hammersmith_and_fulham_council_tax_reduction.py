...
class hammersmith_and_fulham_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Hammersmith and Fulham Council Tax Support"
    ...
    def formula(benunit, period, parameters):
        ...
        return legacy_council_tax_reduction(
            ...
            ctr,
            working_age,
            "hammersmith_and_fulham_council_tax_reduction_non_dep_deductions",
