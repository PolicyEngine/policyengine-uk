...
class lancaster_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "Lancaster Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        working_age = is_lancaster_working_age(local_authority, country, has_pensioner)
