...
class east_cambridgeshire_council_tax_reduction(Variable):
    value_type = float
    entity = BenUnit
    label = "East Cambridgeshire Council Tax Reduction"
    ...
    def formula(benunit, period, parameters):
        ...
        return legacy_council_tax_reduction(
            ...
            ctr,
            working_age,
            "east_cambridgeshire_council_tax_reduction_non_dep_deductions",
        )
