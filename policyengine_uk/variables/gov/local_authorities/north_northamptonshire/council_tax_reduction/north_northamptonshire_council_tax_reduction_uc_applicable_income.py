...
class north_northamptonshire_council_tax_reduction_uc_applicable_income(Variable):
    value_type = float
    entity = BenUnit
    label = (
        "North Northamptonshire Council Tax Support Universal Credit applicable income"
    )
