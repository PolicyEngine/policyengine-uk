...
class gateshead_council_tax_reduction_individual_non_dep_deduction(Variable):
    value_type = float
    entity = Person
    label = "Gateshead CTR individual non-dependent deduction"
    ...
    def formula(person, period, parameters):
        ...
        working_age = is_gateshead_working_age(
