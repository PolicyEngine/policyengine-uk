...
class brentwood_council_tax_reduction_esa_support_component(Variable):
    value_type = bool
    entity = BenUnit
    label = "Brentwood CTR source input - applicant, partner, or dependant gets ESA Support Component"
    documentation = "Brentwood Schedule 1 paragraph 3 uplifts the band discount to 100 percent where the applicant, partner, or any dependant gets Employment and Support Allowance with the Support Component. PolicyEngine UK does not separately model the ESA Support Component, so this Brentwood-scoped source input lets a household assert receipt for the protected-group test. Default False."
