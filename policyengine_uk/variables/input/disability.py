...
from policyengine_uk.variables.output.misc.categories.lower_middle_or_higher import (
    LowerMiddleOrHigher,
)
from policyengine_uk.variables.output.misc.categories.lower_or_higher import (
    LowerOrHigher,
)
